...
python -u examples/train_multi_source.py -a ${ARCH} --seed ${SEED} --margin 0.3 \
	...
	--logs-dir logs/MECL_to_market/${ARCH}-${DESC} \
	--train-lists  /mnt/lustre/viface/share/ReID/data_list/MSMT17_V1/train.txt \
	/mnt/lustre/viface/share/ReID/data_list/dukemtmc-reid/train.txt \
	/mnt/lustre/viface/share/ReID/data_list/cuhk03_1/train.txt \
	--root /mnt/lustre/viface/share/ReID/ReID_dataset/datasets8 \
	--query-list /mnt/lustre/viface/share/ReID/data_list/market1501/probe.txt \
  --gallery-list /mnt/lustre/viface/share/ReID/data_list/market1501/gallery.txt \
  --validate \
